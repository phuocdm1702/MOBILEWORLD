...
import mobileworld.main.Login;
import mobileworld.model.ModelMenu;
import mobileworld.swing.ButtonCustom;
...
public class Menu extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.decode("#11998e"), 0, getHeight(), Color.decode("#0d7a68"));
        g2.setPaint(gra);
