...
public class MauSacDialog extends javax.swing.JFrame {
    ...
    public void setEventMauSacDialog(EventMauSacDialog mauSacDialog) {
        this.mauSacDialog = mauSacDialog;
    }

    private void showDataTableSanPham(List<MauSacEntity> lists) {
        tblModel.setRowCount(0);
        int stt = 0;
        for (MauSacEntity ms : lists) {
            stt++;
    ...
    private MauSacEntity getFormData() {
        String tenMauSac = txtMauSac.getText();
        LocalDate dateTime = LocalDate.now();

        MauSacEntity ms = new MauSacEntity(tenMauSac, 1, dateTime, "NV0003");
        return ms;
    }
    ...
    private void initComponents() {
        ...
        tblMauSac = new mobileworld.swing.Table();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtMauSac, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(10, 10, 10))
        );
    ...
    private void buttonCustom2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCustom2ActionPerformed
        ...
        MauSacEntity ms = service.getAll().get(i);
        service.update(getFormData(), ms.getId());
        showDataTableSanPham(service.getAll());
        notifyDataChangeListeners();
    ...
    private void tblMauSacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMauSacMouseClicked
        int i = tblMauSac.getSelectedRow();
        MauSacEntity ms = service.getAll().get(i);
        txtMauSac.setText(ms.getTenMau());
    ...
    private mobileworld.swing.Table tblMauSac;
