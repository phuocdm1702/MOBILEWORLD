...
import mobileworld.service.DongSPService;
...
public class SPDialog extends javax.swing.JFrame {
    ...
    public EventSPDialog eventSPDialog;
    ...
    public SPDialog() {
        ...
        tblModel = (DefaultTableModel) tblDsp.getModel();
        showDataTableSanPham(service.getAll());
        pack();
    }

    public void setEventSPDialog(EventSPDialog eventSPDialog) {
        this.eventSPDialog = eventSPDialog;
    }

    private void showDataTableSanPham(List<DongSPEntity> lists) {
        tblModel.setRowCount(0);
        int stt = 0;
        for (DongSPEntity dsp : lists) {
            stt++;
    ...
    private DongSPEntity getFormData() {
        String tenSP = txtSp.getText();
        LocalDate dateTime = LocalDate.now();

        DongSPEntity dsp = new DongSPEntity(tenSP, 1, dateTime, "NV0003");
        return dsp;
    }
    ...
    private void initComponents() {
        ...
        tblDsp = new mobileworld.swing.Table();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtSp, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(10, 10, 10))
        );
    ...
    private void tblDspMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDspMouseClicked
        ...
        DongSPEntity sp = service.getAll().get(i);
        txtSp.setText(sp.getTenDsp());
    ...
    private void buttonCustom2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCustom2ActionPerformed
        int i = tblDsp.getSelectedRow();
        DongSPEntity sp = service.getAll().get(i);
        service.update(getFormData(), sp.getId());
        showDataTableSanPham(service.getAll());
        notifyDataChangeListeners();
    ...
    private mobileworld.swing.Table tblDsp;
